# Generated by Django 5.2.4 on 2025-07-20 18:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='created_at',
            field=models.DateTimeField(auto_now_add=True, default=datetime.datetime(2025, 7, 20, 18, 32, 28, 179952, tzinfo=datetime.timezone.utc)),
        ...
        migrations.AddConstraint(
            model_name='meditation',
            constraint=models.UniqueConstraint(condition=models.Q(('external_id__isnull', False), models.Q(('external_id', ''), _negated=True)), fields=('source', 'external_id'), name='unique_external_content'),
        ),
        migrations.AddField(
